...
export const builtInCommandNames = () => new Set(['add-dir', 'clear', 'theme', 'help', 'exit', 'logout', 'model', 'effort', 'config', 'context', 'usage']);
export const getMcpSkillCommands = (cmds: any) => [];

export const REMOTE_SAFE_COMMANDS: Set<Command> = new Set([clear, theme, help, exit, model, effort, config]);
export default [addDir, clear, theme, help, exit, logout, model, effort, config, context, usage];
